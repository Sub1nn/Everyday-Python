...
data = pd.read_json("python_broadway/011_python_project/012_extras/nepse_scrape/classwork/today_prices.json")
df = pd.DataFrame(data) # pandas le bujne data type
